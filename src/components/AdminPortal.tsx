...
export const AdminPortal: React.FC<AdminPortalProps> = ({
  ...
  const sessionsList: SimulatedSession[] = [
    ...
    {
      id: 'session-cambridge-cardio',
      userEmail: 'cardio.research@cambridge.ac.uk',
      displayName: 'Dr. Arthur Pendelton',
      role: 'Academic Researcher',
      organization: 'University of Cambridge, Dept of Medicine',
      paperCount: 43,
      chunkCount: 284,
  ...
  const auditLogs = [
    ...
    },
    {
      ...
      sessionId: 'session-cambridge-cardio',
      model: 'gemini-2.5-flash',
      latency: 489,
      tokens: 2210,
      retrievedChunks: 4,
