    ...
    <div className="flex-1 overflow-y-auto bg-slate-50/70 p-4 sm:p-6 lg:p-8">
      <div className="max-w-7xl mx-auto grid grid-cols-1 xl:grid-cols-12 gap-6">
        ...
        <div className="xl:col-span-8 space-y-6">
          ...
          {/* Hero Banner */}
          <div className="relative overflow-hidden rounded-3xl bg-gradient-to-r from-teal-50 via-sky-50 to-blue-50/50 border border-teal-200/70 p-6 sm:p-8 shadow-xs">
            ...
            <div className="absolute right-0 top-0 bottom-0 w-1/3 opacity-15 pointer-events-none flex items-center justify-end pr-4">
              <svg className="w-64 h-64 text-teal-700" viewBox="0 0 200 200" fill="currentColor">
            ...
            <div className="relative z-10 max-w-2xl space-y-3">
              <div className="inline-flex items-center space-x-2 px-3 py-1 rounded-full bg-teal-100/80 border border-teal-300/50 text-teal-800 text-xs font-semibold">
              ...
              <div className="space-y-1">
                <h1 className="text-2xl sm:text-3xl font-extrabold text-slate-900 tracking-tight">
                  ScholarFlow <span className="text-teal-700">AI</span>
                </h1>
              ...
              {activeDomain !== 'all' && currentDomainMeta && (
                <div className="pt-1 flex items-center space-x-2">
                  <span className="text-2xs font-semibold text-slate-500">Active Topic Focus:</span>
                  ...
                  <button
                    ...
                    className="text-2xs text-teal-700 hover:text-teal-900 font-semibold underline ml-1 cursor-pointer"
                  >
                    Reset to All
                  </button>
                </div>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-3.5">
            ...
            <div className="bg-white p-4 rounded-2xl border border-slate-200 shadow-2xs space-y-1">
              <div className="flex items-center justify-between text-slate-400">
                <span className="text-2xs font-bold uppercase tracking-wider text-slate-400">Papers Ingested</span>
                <FileText className="w-4 h-4 text-teal-600" />
              </div>
              <div className="text-2xl font-black text-slate-900">{paperCount}</div>
              <div className="text-3xs text-slate-500">In this session</div>
            </div>

            {/* Card 2: Research Corpus */}
            <div className="bg-white p-4 rounded-2xl border border-slate-200 shadow-2xs space-y-1">
              <div className="flex items-center justify-between text-slate-400">
                <span className="text-2xs font-bold uppercase tracking-wider text-slate-400">Research Corpus</span>
                <Layers className="w-4 h-4 text-sky-600" />
              </div>
              <div className="text-2xl font-black text-slate-900">{corpusCount}</div>
              <div className="text-3xs text-slate-500">Total documents</div>
            </div>

            {/* Card 3: AI Queries */}
            <div className="bg-white p-4 rounded-2xl border border-slate-200 shadow-2xs space-y-1">
              <div className="flex items-center justify-between text-slate-400">
                <span className="text-2xs font-bold uppercase tracking-wider text-slate-400">AI Queries</span>
                <Sparkles className="w-4 h-4 text-amber-500" />
              </div>
              <div className="text-2xl font-black text-slate-900">∞</div>
              <div className="text-3xs text-slate-500">Ask anything</div>
            </div>

            {/* Card 4: AI Engine */}
            <div className="bg-white p-4 rounded-2xl border border-slate-200 shadow-2xs space-y-1">
              <div className="flex items-center justify-between text-slate-400">
                <span className="text-2xs font-bold uppercase tracking-wider text-slate-400">AI Engine</span>
                <Cpu className="w-4 h-4 text-indigo-600" />
              </div>
              <div className="text-sm font-black text-slate-900 truncate">Gemini 2.5 Flash</div>
              <div className="text-3xs text-slate-500 truncate">Multimodal • Fast • Reliable</div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3.5">
            ...
            <div 
              ...
              className="bg-white p-4 rounded-2xl border border-slate-200 hover:border-emerald-300 hover:shadow-sm transition-all cursor-pointer group flex flex-col justify-between"
            >
              <div>
                <div className="w-9 h-9 rounded-xl bg-emerald-50 border border-emerald-200 text-emerald-600 flex items-center justify-center mb-2.5 group-hover:scale-105 transition-transform">
                  <UploadCloud className="w-5 h-5" />
                </div>
                <h3 className="text-xs font-bold text-slate-900 mb-0.5">Upload Papers</h3>
                <p className="text-3xs text-slate-500">PDF, LaTeX, Text, Markdown</p>
              </div>
              <div className="mt-3 text-3xs font-bold text-emerald-600 flex items-center space-x-1 group-hover:translate-x-0.5 transition-transform">
            ...
            <div 
              ...
              className="bg-white p-4 rounded-2xl border border-slate-200 hover:border-blue-300 hover:shadow-sm transition-all cursor-pointer group flex flex-col justify-between"
            >
              <div>
                <div className="w-9 h-9 rounded-xl bg-blue-50 border border-blue-200 text-blue-600 flex items-center justify-center mb-2.5 group-hover:scale-105 transition-transform">
                  <MessageSquare className="w-5 h-5" />
                </div>
                <h3 className="text-xs font-bold text-slate-900 mb-0.5">Ask Scholar Chat</h3>
                <p className="text-3xs text-slate-500">Get grounded answers</p>
              </div>
              <div className="mt-3 text-3xs font-bold text-blue-600 flex items-center space-x-1 group-hover:translate-x-0.5 transition-transform">
                <span>Open Chat</span>
                <ArrowRight className="w-3 h-3" />
              </div>
            </div>
            ...
            <div 
              ...
              className="bg-white p-4 rounded-2xl border border-slate-200 hover:border-purple-300 hover:shadow-sm transition-all cursor-pointer group flex flex-col justify-between"
            >
              <div>
                <div className="w-9 h-9 rounded-xl bg-purple-50 border border-purple-200 text-purple-600 flex items-center justify-center mb-2.5 group-hover:scale-105 transition-transform">
                  <GitCompare className="w-5 h-5" />
                </div>
                <h3 className="text-xs font-bold text-slate-900 mb-0.5">Compare Papers</h3>
                <p className="text-3xs text-slate-500">Side-by-side analysis</p>
              </div>
              <div className="mt-3 text-3xs font-bold text-purple-600 flex items-center space-x-1 group-hover:translate-x-0.5 transition-transform">
            ...
            <div 
              ...
              className="bg-white p-4 rounded-2xl border border-slate-200 hover:border-amber-300 hover:shadow-sm transition-all cursor-pointer group flex flex-col justify-between"
            >
              <div>
                <div className="w-9 h-9 rounded-xl bg-amber-50 border border-amber-200 text-amber-600 flex items-center justify-center mb-2.5 group-hover:scale-105 transition-transform">
                  <BarChart3 className="w-5 h-5" />
                </div>
                <h3 className="text-xs font-bold text-slate-900 mb-0.5">Extract Insights</h3>
                <p className="text-3xs text-slate-500">Figures, tables, equations</p>
              </div>
              <div className="mt-3 text-3xs font-bold text-amber-600 flex items-center space-x-1 group-hover:translate-x-0.5 transition-transform">
          ...
          <div className="bg-white rounded-3xl border border-slate-200 shadow-xs p-5 sm:p-6 space-y-4">
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-2">
                ...
                <h2 className="text-sm font-extrabold text-slate-900">Ask Your Research Question</h2>
              </div>
              <div className="relative">
                <button
                  type="button"
                  onClick={() => setDeepResearchMode(!deepResearchMode)}
                  className="flex items-center space-x-1.5 px-3 py-1 rounded-xl bg-teal-50 border border-teal-200 text-2xs font-bold text-teal-800 hover:bg-teal-100 transition-colors cursor-pointer"
                >
                  <Zap className="w-3 h-3 text-teal-600" />
                  <span>{deepResearchMode ? 'Deep Research Enabled' : 'Standard Query'}</span>
                  <ChevronDown className="w-3 h-3 text-teal-600 ml-0.5" />
                </button>
              </div>
            </div>
            ...
            <form onSubmit={handleQuerySubmit} className="space-y-3">
              <div className="relative rounded-2xl border border-slate-200 focus-within:border-teal-500 focus-within:ring-2 focus-within:ring-teal-500/10 transition-all bg-slate-50/50">
                <textarea
                  ...
                  className="w-full p-4 text-xs sm:text-sm bg-transparent outline-hidden text-slate-800 placeholder-slate-400 resize-none font-normal leading-relaxed"
                />

                {/* Bottom Toolbar inside the box */}
                <div className="p-3 border-t border-slate-100/80 flex items-center justify-between bg-white rounded-b-2xl">
              ...
              <div className="flex flex-wrap gap-1.5">
                {activeSuggestedExamples.map((item, idx) => (
                  <button
                    ...
                    className="text-2xs px-3 py-1.5 rounded-full bg-slate-100 hover:bg-teal-50 hover:text-teal-800 hover:border-teal-300 border border-slate-200 text-slate-700 font-medium transition-colors cursor-pointer"
                  >
                    {item.label}
                  </button>
                ))}
          ...
          <div className="bg-white rounded-3xl border border-slate-200 shadow-xs p-6 space-y-4">
            <div className="flex items-center justify-between">
              <h2 className="text-sm font-extrabold text-slate-900">Powerful Features for Researchers</h2>
              <button
                type="button"
                onClick={() => onNavigateTab('literature')}
                className="text-2xs font-bold text-teal-700 hover:text-teal-900 flex items-center space-x-1"
              >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3.5">
              {/* Feature 1 */}
              <div className="p-3.5 rounded-2xl bg-slate-50/70 border border-slate-100 space-y-1.5">
                <div className="w-8 h-8 rounded-xl bg-teal-50 border border-teal-200 text-teal-700 flex items-center justify-center">
                  <Sparkles className="w-4 h-4" />
                </div>
                <h4 className="text-xs font-bold text-slate-900">Multimodal Understanding</h4>
              ...
              <div className="p-3.5 rounded-2xl bg-slate-50/70 border border-slate-100 space-y-1.5">
                ...
                <h4 className="text-xs font-bold text-slate-900">Evidence-Grounded Answers</h4>
                <p className="text-3xs text-slate-500 leading-relaxed">
              ...
              <div className="p-3.5 rounded-2xl bg-slate-50/70 border border-slate-100 space-y-1.5">
                ...
                <h4 className="text-xs font-bold text-slate-900">Literature Matrix</h4>
                <p className="text-3xs text-slate-500 leading-relaxed">
              ...
              <div className="p-3.5 rounded-2xl bg-slate-50/70 border border-slate-100 space-y-1.5">
                ...
                <h4 className="text-xs font-bold text-slate-900">Custom Research Corpus</h4>
                <p className="text-3xs text-slate-500 leading-relaxed">
              ...
              <div className="p-3.5 rounded-2xl bg-slate-50/70 border border-slate-100 space-y-1.5">
                ...
                <h4 className="text-xs font-bold text-slate-900">Export & Share</h4>
                <p className="text-3xs text-slate-500 leading-relaxed">
          ...
          <div className="bg-white rounded-3xl border border-slate-200 shadow-xs p-6 space-y-4">
            <div className="flex items-center justify-between">
              <h2 className="text-sm font-extrabold text-slate-900">Recent Projects</h2>
              <button
                type="button"
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3.5">
              {DEMO_PROJECTS.slice(0, 3).map((proj) => (
                <div
                  key={proj.id}
                  onClick={() => onNavigateTab('projects')}
                  className="p-4 rounded-2xl border border-slate-200 hover:border-slate-300 hover:shadow-xs transition-all cursor-pointer flex flex-col justify-between"
                >
                  ...
                  <div className="pt-3 border-t border-slate-100 mt-2 flex items-center justify-between text-3xs text-slate-500 font-medium">
                    <span>{proj.paperCount} papers</span>
                    <span className="text-teal-700 font-bold">Open &rarr;</span>
                  </div>
                </div>
              ))}
            </div>
        ...
        <div className="xl:col-span-4 space-y-6">
          ...
          <div className="bg-white rounded-3xl border border-slate-200 shadow-xs p-5 space-y-3">
            ...
            <div className="space-y-1.5">
              <button
                ...
                onClick={onOpenUpload}
                className="w-full flex items-center space-x-2.5 p-2.5 rounded-xl hover:bg-slate-50 border border-slate-100 text-left transition-colors text-xs font-medium text-slate-800"
              >
          ...
          <div className="bg-white rounded-3xl border border-slate-200 shadow-xs p-5 space-y-3">
            <div className="flex items-center justify-between">
              <h3 className="text-xs font-extrabold text-slate-900 uppercase tracking-wider">Research Domains</h3>
              <button
                type="button"
                id="manage-domains-btn"
                onClick={onOpenDomainManager}
                className="text-2xs font-bold text-teal-700 hover:text-teal-900 cursor-pointer"
              >
                Manage
              </button>
            </div>
          ...
          <div className="bg-white rounded-3xl border border-slate-200 shadow-xs p-5 space-y-3">
            <div className="flex items-center justify-between">
              ...
              <button
                type="button"
                onClick={() => onNavigateTab('chat')}
                className="text-2xs font-bold text-teal-700 hover:text-teal-900"
              >
                View All
              </button>
            </div>
            ...
            <div className="space-y-2.5">
              ...
              <div className="flex items-start space-x-2.5 text-xs">
                ...
                <div className="space-y-0.5">
                  <div className="font-semibold text-slate-800">Ready to answer questions</div>
      ...
      {/* Bottom Footer matching Image 1 */}
      <footer className="max-w-7xl mx-auto mt-8 pt-6 border-t border-slate-200 flex flex-col sm:flex-row items-center justify-between text-2xs text-slate-500 gap-3">
        <div className="flex items-center space-x-2">
          <span className="font-bold text-slate-700">ScholarFlow AI™</span>
          <span>|</span>
